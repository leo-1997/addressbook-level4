...
/**
 * Represents a distinct part of the UI. e.g. Windows, dialogs, panels, status bars, etc. It contains a scene
 * graph with a root node of type {@code T}.
 */
public abstract class UiPart<T> {
    ...
    /**
     * Constructs a UiPart with the specified FXML file URL and root object. The FXML file must not specify
     * the {@code fx:controller} attribute.
     */
