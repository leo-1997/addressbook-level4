...
public class UiManager extends ComponentManager implements Ui {
    ...
    /**
     * Shows an alert dialog on {@code owner} with the given parameters. This method only returns after the
    ...
    /**
     * Shows an error alert dialog with {@code title} and error message, {@code e}, and exits the application
