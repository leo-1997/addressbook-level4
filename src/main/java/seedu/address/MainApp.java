...
import seedu.address.storage.XmlSaveItStorage;
...
public class MainApp extends Application {
     ...
     * <br> The data from the sample address book will be used instead if {@code storage}'s address book is
    ...
    /**
     * Returns a {@code UserPrefs} using the file at {@code storage}'s user prefs file path, or a new {@code
     * UserPrefs} with default configuration if errors occur when reading from the file.
     */
