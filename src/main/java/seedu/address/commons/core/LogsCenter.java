...
/**
 * Configures and manages loggers and handlers, including their logging level Named {@link Logger}s can be
 * obtained from this class<br> These loggers have been configured to output messages to the console and a
 * {@code .log} file by default, at the {@code INFO} level. A new {@code .log} file with a new numbering will
...
public class LogsCenter {
    ...
    private static final String LOG_FILE = "address.log";
    ...
    /**
     * Initializes with a custom log level (specified in the {@code config} object) Loggers obtained *AFTER*
     * this initialization will have their logging level changed<br> Logging levels for existing loggers will
     * only be updated if the logger with the same name is requested again from the LogsCenter.
     */
    ...
    /**
     * Adds the {@code consoleHandler} to the {@code logger}. <br> Creates the {@code consoleHandler} if it is
     * null.
     */
