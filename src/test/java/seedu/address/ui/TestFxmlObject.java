...
/**
 * A test object which can be constructed via an FXML file. Unlike other JavaFX classes, this class can be
 * constructed without the JavaFX toolkit being initialized.
 */
