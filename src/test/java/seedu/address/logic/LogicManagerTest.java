...
public class LogicManagerTest {
     ...
     * thrown, and also confirms that the following two parts of the LogicManager object's state are as
     * expected:<br> - the internal model manager data are same as those in the {@code expectedModel} <br> -
